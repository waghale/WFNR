...
class MyNotesAdapter(
    val context: Context,
    val  itineraries: List<Topic_Notes>
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(data: Topic_Notes, position: Int) {
            TextView_ST_timeslotTitle.text=data.topic_title
            ...
            TextView_Question.text=data.topic_note

        }
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.my_notes_item, parent, false)
